...
export const sites = {
    ...
    filecs: ["eac4", "#239120"],
    filecss: ["eac5", "#1572b6"],
    filedart: ["eaca", "#0175C2"],
    filegd: ["eb4b", "#478cbf"],
    filego: ["eb4a", "#4ec6e4"],
    filehaskell: ["eb75", "#5D4F85"],
    filehtml: ["eb85", "#e34f26"],
    filejava: ["ebac", "#007396"],
    filejs: ["ebad", "#f7df1e"],
    filejson: ["ebb9", "#A9BACD"],
    filejupyter: ["ebba", "#F37626"],
    filekotlin: ["ebcd", "#7F52FF"],
    filelatex: ["ebd5", "#008080"],
    filelua: ["ebeb", "#000080"],
    filephp: ["ec6c", "#474A8A"],
    filepowershell: ["ec84", "#012456"], // colour of bg default ps
    filepy: ["ec92", "#3776AB"],
    filer: ["eca1", "#276DC3"],
    filereact: ["eca6", "#61DAFB"],
    filereactjsx: ["eca6", "#61DAFB"],
    filereacttsx: ["eca6", "#61DAFB"],
    filers: ["ecc1", "#D34516"],
    fileruby: ["ecbe", "#CC342D"],
    filesass: ["ecc9", "#CC6699"],
    filesvelte: ["ed26", "#FF3E00"],
    fileswift: ["ed2b", "#F05138"],
    filets: ["ed59", "#3178C6"],
};
